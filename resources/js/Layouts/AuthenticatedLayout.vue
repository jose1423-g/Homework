    ...
    <nav class="sticky top-0 bg-white border-b border-gray-100">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="flex items-center shrink-0">
                        ...
                        <ApplicationLogo class="block w-auto h-10 text-gray-800 fill-current" />
                        </Link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <NavLink :href="route('maestros')" :active="route().current('maestros')">
                            Materias
                        </NavLink>
                    </div>
                </div>
        ...
        <div :class="{
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                <ResponsiveNavLink :href="route('maestros')" :active="route().current('maestros')">
                    Materias
                </ResponsiveNavLink>
            </div>
