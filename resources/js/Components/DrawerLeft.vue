...
<template>        
    ...
    <div class="bg-red-700">
        ...
        <!-- drawer -->
        <div 
            :class="['fixed top-0 right-0 w-full sm:w-[30rem] h-full rounded-l-xl bg-white shadow-lg transform transition-transform duration-300', { 'translate-x-full': !isOpen }]"        
        >        
